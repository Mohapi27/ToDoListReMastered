...
<body>
	...
	<div class="container">
	<form:form class="form-horizontal" commandName="member" enctype="multipart/form-data" action="saveNewMember.html">
		<fieldset>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<form:input path="surname" name="surname" class="form-control" placeholder="Surname" />
